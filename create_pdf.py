...
class PDF(FPDF):
    ...
    def chapter_body(self, body):
        ...
        body = body.replace('’', "'")  # Replace curly apostrophe with straight apostrophe
    ...
    def add_link(self, text, link):
        ...
        self.cell(0, 10, text, 0, 1, 'L', False, link)
...
# Save PDF
pdf_output_path = "/mnt/data/Shoes_for_Plus_Size_Nurses.pdf"
pdf.output(pdf_output_path)

pdf_output_path

To create a nicely formatted PDF for your boss summarizing the research |oai:code-citation|
